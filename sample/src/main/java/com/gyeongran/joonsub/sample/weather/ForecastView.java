...
public class ForecastView extends LinearLayout {
    ...
    private int[] weatherToGradient(Weather weather) {
        switch (weather) {
            ...
            case LIGHT_1:
                return colors(R.array.gradientLight_1);//우리가 그라데이션을 만들어서 넣어야돼
            case LIGHT_2:
                return colors(R.array.gradientLight_2);
            case LIGHT_3:
                return colors(R.array.gradientLight_3);
            case TEMPERATURE_1:
                return colors(R.array.gradientTemperature_1);
            case TEMPERATURE_2:
                return colors(R.array.gradientTemperature_2);
            case TEMPERATURE_3:
                return colors(R.array.gradientTemperature_3);
            case TEMPERATURE_4:
                return colors(R.array.gradientTemperature_4);
            case HUMIDITY_1:
                return colors(R.array.gradientHumidity_1);
            case HUMIDITY_2:
                return colors(R.array.gradientHumidity_2);
            case HUMIDITY_3:
                return colors(R.array.gradientHumidity_3);
            case HUMIDITY_4:
                return colors(R.array.gradientHumidity_4);
            default:
    ...
    private int weatherToIcon(Weather weather) {
        switch (weather) {
            ...
            case LIGHT_1:
                return R.drawable.light_1;
            case LIGHT_2:
                return R.drawable.light_2;
            case LIGHT_3:
                return R.drawable.light_3;
            case TEMPERATURE_1:
                return R.drawable.temperature_1;
            case TEMPERATURE_2:
                return R.drawable.temperature_2;
            case TEMPERATURE_3:
                return R.drawable.temperature_3;
            case TEMPERATURE_4:
                return R.drawable.temperature_4;
            case HUMIDITY_1:
                return R.drawable.humidity_1;
            case HUMIDITY_2:
                return R.drawable.humidity_2;
            case HUMIDITY_3:
                return R.drawable.humidity_3;
            case HUMIDITY_4:
                return R.drawable.humidity_4;
